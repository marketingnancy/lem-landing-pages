...
import { Star, Check, Package, Shield, Truck, Clock, Award, Heart, Edit3, Sun, Moon, Droplets, Activity, Sparkles } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <section className="container max-w-4xl py-8">
        <img
          src="/hero.png"
          alt="Woman enjoying a peaceful morning wellness routine"
          className="w-full rounded-lg shadow-lg"
        />
        <p className="text-sm text-gray-500 mt-2 italic">The habits that feel the smallest often carry the most weight. Photo: Wellness Insider</p>
      </section>
