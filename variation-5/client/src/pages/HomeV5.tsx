...
import { Star, Check, Package, Shield, Truck, Clock, Award, Heart, Edit3, Users, MessageCircle, HandHeart } from "lucide-react";
...
export default function HomeV5() {
  ...
  const galleryImages = [
    { src: "/v5-no-age-limit.jpg", alt: "Pleasure Has No Age Limit" },
    { src: "/v5-all-about-lem.jpg", alt: "All about Lem features" },
    { src: "/v5-happy-customers.jpg", alt: "Join 500,000+ Happy Customers" },
    { src: "/v5-pink-silk.jpg", alt: "Lem on pink silk" },
    { src: "/v5-body-shot.jpg", alt: "Woman holding Lem" },
  ];
  ...
  return (
    <div className="min-h-screen bg-white relative">
      ...
      <section className="container max-w-4xl py-8">
        <img src="/v5-happy-customers.jpg" alt="Join 500,000+ Happy Customers — you're not alone" className="w-full rounded-lg shadow-lg" />
      ...
      <article className="container max-w-4xl py-12 space-y-10">
        ...
        <div>
          ...
          <div className="bg-[#FFE14D]/20 p-6 rounded-xl mb-6">
            <div className="max-w-md mx-auto mb-6">
              <img src="/v5-all-about-lem.jpg" alt="All about Lem - Whisper-Quiet, Waterproof, Discreet" className="w-full rounded-lg shadow-lg" />
            </div>
        ...
        <div className="bg-gradient-to-r from-[#FFE14D]/20 to-white p-8 rounded-xl my-12">
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              <img src="/v5-no-age-limit.jpg" alt="Pleasure Has No Age Limit" className="w-full rounded-lg shadow-lg" />
            </div>
            <div className="space-y-4">
              <p className="text-gray-700 leading-relaxed">
